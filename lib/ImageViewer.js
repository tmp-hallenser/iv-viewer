...
var ImageViewer = /*#__PURE__*/function () {
  ...
  _createClass(ImageViewer, [{
    ...
    value: function _snapViewEvents() {
      ...
      this._events.mouseEnterImageWrap = (0, _util.assignEvent)(imageWrap, ['mouseenter', 'touchstart'], function () {
        _this5.playVideo();
      }); // pause video on mouseleave

      this._events.mouseLeaveImageWrap = (0, _util.assignEvent)(imageWrap, ['mouseleave', 'touchend'], function () {
        _this5.pauseVideo();
    ...
    value: function _loadImages() {
      ...
      var onImageLoad = function onImageLoad() {
        ...
        if (lowResImageSrc) {
          ...
          var _image = (0, _util.createElement)({
            tagName: 'img',
            className: 'iv-image iv-small-image',
            src: imageSrc,
          ...
          if ((0, _util.imageLoaded)(_image)) {// onHighResImageLoad(); //TODO
          } else {
            _this9._events.mediumResImageLoad = (0, _util.assignEvent)(_image, 'load', onMediumResImageLoad);
          }
        } else {
          // load high resolution image if provided
          if (hiResImageSrc && _this9._options.loadHiResImageOnLoad) {
    ...
    value: function _loadVideo(videoSrc) {
      ...
      var video = (0, _util.createElement)({
        tagName: 'video',
        className: 'iv-image iv-small-image',
        src: videoSrc,
        parent: imageWrap,
      ...
      if ((0, _util.imageLoaded)(video)) {
        onHighResImageLoad();
      } else {
        this._events.videoLoad = (0, _util.assignEvent)(video, 'load', onVideoLoad);
        this._events.videoProgress = (0, _util.assignEvent)(video, 'progress', onVideoProgress);
        this._events.videoLoad = (0, _util.assignEvent)(video, 'play', onVideoPlay);
        this._events.videoLoad = (0, _util.assignEvent)(video, 'playing', onVideoPlay);
        this._events.videoProgress = (0, _util.assignEvent)(video, 'pause', onVideoPause);
        this._events.videoProgress = (0, _util.assignEvent)(video, 'canplay', onVideoCanPlay);
        this._events.videoProgress = (0, _util.assignEvent)(video, 'waiting', onVideoWaiting);
      }
    }
  }, {
